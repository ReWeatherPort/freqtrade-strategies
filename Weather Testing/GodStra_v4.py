...
class GodStra_v4(IStrategy):
    ...
    minimal_roi = {
        "0": 0.1,    # Adjusted for short-term trades
        "30": 0.05,
        "60": 0
    }
    ...
    buy_real_num0 = DecimalParameter(
        0, 1, decimals=DECIMALS, default=0.85, space='buy')
    buy_real_num1 = DecimalParameter(
        0, 1, decimals=DECIMALS, default=0.5, space='buy')
    ...
    sell_indicator0 = CategoricalParameter(
        god_genes_with_timeperiod, default="RSI-14", space='sell')
    ...
    sell_real_num0 = DecimalParameter(
        0, 1, decimals=DECIMALS, default=0.9, space='sell')
